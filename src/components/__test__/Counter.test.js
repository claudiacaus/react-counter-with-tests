...
test('clicking in the plus btn adds 1 to counter', () => {
  const addBtn = getByTestId('add-btn');
  const counterEl = getByTestId('counter');
...
test('clicking in the subtract btn subtracts 1 from the counter', () => {
  const subtractBtn = getByTestId('subtract-btn');
  const counterEl = getByTestId('counter');
...
test('change input then clicking on add btn works correctly', () => {
  const addBtn = getByTestId('add-btn');
  const counterEl = getByTestId('counter');
  const inputEl = getByTestId('input');
...
test('change input then clicking on subtract btn works correctly', () => {
  const subtractBtn = getByTestId('subtract-btn');
  const counterEl = getByTestId('counter');
  const inputEl = getByTestId('input');
